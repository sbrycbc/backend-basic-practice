...
{
    // wir holen uns den token aus den cookies, anhand des namens, In konvention werden cookie namen mit unterstrich zwischen den worten getrennt:
    const token = req.cookies.access_token;

    // wenn kein cookie gefunden wurde, senden wir einen status 403: Forbidden, da wir dem nutzer verbieten die route zu besuchen
    if(!token)
    {
